...
def title(text, screen, scale, color=(0, 0, 0)):
    ...
    # font = pygame.font.SysFont('宋体', 27)
    # font = pygame.font.SysFont('msyh', 27)
...
def main():
    ...
    # 添加背景音乐
    pygame.mixer.music.load('武侠版本.mp3')
    ...
    while running:
        ...
        screen.fill((255, 255, 255))
        # 添加背景图
        background = pygame.image.load('ab8fe3fff7447c3bef8eb21cafc22c5e.jpg').convert()
